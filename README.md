...
This repository holds a database of a clinic and its patients made from scratch based off [a select diagram](https://github.com/microverseinc/curriculum-databases/blob/main/db-structure/images/clinic_diagram.png)
...
```sh
  git clone https://github.com/Arch-Noize/database-diagram.git
  cd database-diagram
```
